document.addEventListener('DOMContentLoaded', function() {
    ...
    function getUTMParams() {
        ...
        ['utm_source', 'utm_medium', 'utm_campaign', 'utm_content', 'utm_term', 'utm_id', 'xcod'].forEach(param => {
    ...
    function redirecionarParaChat() {
        ...
        try {
            ...
            window.location.href = `./chat.html?${novaUrl.toString()}`;
